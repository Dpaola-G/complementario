...
const protagonista_2 = new Protagonista ({genero:"masculino",nombre: "Henry Cavaciel",nacionalidad:"EstadoUnidense", premios: "Premios Oscar", protagonicos: 5});
console.log(protagonista_2);

const protagonista_1 = new Protagonista ({genero:"femenino",nombre:"Keanu Reeves", nacionalidad: "EstadoUnidense", premios:"Premios Oscar", protagonicos: 3});
